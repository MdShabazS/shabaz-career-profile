...
- Corrected the Pega National Internship Program duration to 1 month (user-confirmed 2026-08-20); previously recorded as 5 months. Updated `AI_CONTEXT.md`, `experience/pega.md`, `experience/experience-index.yaml`, `resume/MASTER_RESUME.md`, and `superset/profile-submission.md`. Program size (60 hours) is a separate, unchanged field.
